				<div id="sidebar1" class="sidebar fourcol last clearfix" role="complementary">
					...
					<div class="facets">
						...
						<?php if (is_front_page()) {
							...
							echo '<a href="';
							echo home_url();
							echo '">Alle Angebote</a> ';
								} 
							echo ' (' . $gesamt . ') '?> 
							<a class="feed-link" href="<?php echo home_url(); ?>/stellenangebote/feed/"><i class="fa fa-rss" aria-hidden="true"></i> <span>RSS</span></a></div>
						...
						<?php $categories = get_categories('taxonomy=einrichtungstyp');
						...
						<h4><!--<i class="fa fa-filter" aria-hidden="true"></i> -->Filtern nach Stellentyp</h4>
						<!--
						<ul class="job-categories clearfix">
						...
						<?php $categories = get_categories('taxonomy=stellentyp');
						$mycustomtaxonomy = get_queried_object()->term_id;
						foreach( $categories as $category ) {
							$category_name = sprintf(
								'<strong>%1$s</strong>',
